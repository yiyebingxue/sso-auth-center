      ...
      <el-row>
        <el-form>
          <el-form-item style="margin: 0">
            <el-button v-hasPermission="['menu:add']" type="primary" icon="el-icon-plus" size="mini" @click="handleAdd">
              新增
            </el-button>
          </el-form-item>
        </el-form>
      ...
      <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item v-if="form.menuType !== 'F'" prop="icon" label="菜单图标">
                <el-popover
                ...
                >
                  ...
                  <el-input slot="reference" v-model="form.icon" placeholder="可点击选择图标">
                    ...
                    <i
                      v-if="form.icon===null || form.icon==='' || form.icon===undefined"
                      slot="prefix"
            ...
            <el-col v-if="form.menuType === 'C' && form.menuParentId===0" :span="11">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item v-if="form.menuType !== 'F'" label="使用类型" prop="useType">
  ...
  methods: {
    ...
    submitForm: function() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          if (this.form.layoutName !== null && undefined !== this.form.layoutName &&

<template>
  <div>
    <img :src="imgUrl" title="点击上传图标" style="width: 260px; height: 160px;cursor:pointer;" @click="editCropper()">
...
import { uploadSysIcon } from '@/api/system'
  ...
  methods: {
    ...
    uploadImg() {
      this.$refs.cropper.getCropBlob(data => {
        ...
        formData.append('iconFile', data)
        uploadSysIcon(this.sysId, formData).then(response => {

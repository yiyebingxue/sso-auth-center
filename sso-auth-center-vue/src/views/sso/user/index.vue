<template>
  <div class="body-container">
    ...
    <div class="app-container">
      <!--部门数据-->
      <el-col v-if="deptOptions.length>0" :span="deptSpan">
      ...
      <el-col :span="userSpan">
        <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          ...
          <el-row>
            <el-form-item v-if="deptOptions.length>0" label="所属部门" prop="deptId" size="mini">
              <treeselect
        ...
        <el-table v-loading="loading" border :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作" fixed="right" align="center" width="230" class-name="small-padding fixed-width">
            <template v-if="scope.row.supperAdminFlag!==true" slot-scope="scope">
              <el-button
              ...
              <el-button
                v-if="scope.row.sysBindFlag"
                v-hasPermission="['user:removeUserSystem']"
                size="mini"
                type="text"
                icon="el-icon-delete"
                @click="handleRemoveUserSystem(scope.row)"
              >移除
              </el-button>
              <el-button
                v-if="scope.row.userId !== 1"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item v-if="form.userId === undefined" label="登录名" prop="username">
                <el-input v-model="form.username" placeholder="请输入用户登录名" @change="usernameChange" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item v-if="form.userId === undefined" label="登录密码" prop="password">
                <el-input v-model="form.password" placeholder="请输入用户密码" :type="pwdInputType" style="width: 200px;">
                  <i slot="suffix" :class="pwdInputIcon" @click="showPass" />
                </el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="手机号码" prop="phone">
                <el-input v-model="form.phone" placeholder="请输入手机号码" maxlength="11" @change="phoneChange" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
